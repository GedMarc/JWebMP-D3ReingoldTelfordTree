...
(function ($) {
    $.fn.reingoldTree = function (opts) {
        opts = $.extend({}, $.fn.reingoldTree.defaults, opts);
        ...
        function update(source) {
            ...
            nodeEnter.append(NodeMarkerEnterOptions.markerType)
                ...
                .style({
                    "fill": NodeMarkerEnterOptions.fill,
            ...
            nodeEnter.append("text")
                ...
                .style({
                    "font-size": NodeTextEnterOptions.fontSize,
            ...
            nodeUpdate.select("text")
                .style({
                    "font-size": NodeTextOptions.fontSize,
            ...
            nodeExit.select(NodeMarkerExitOptions.markerType)
                ...
                .style({
                    "fill": NodeMarkerExitOptions.fill,
            ...
            nodeExit.select("text")
                .style({
                    "font-size": NodeTextExitOptions.fontSize,
            ...
            link.enter().insert("path", "g")
                ...
                .style({
                    "fill": NodeLinkEnterOptions.fill,
